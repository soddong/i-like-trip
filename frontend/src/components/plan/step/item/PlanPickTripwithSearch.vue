...
<template>
  <v-container fluid class="fill-height d-flex flex-column align-center py-5">
    ...
    <v-sheet style="height: 150px; width: 300px">
      <v-text-field class="mb-2" density="compact" variant="solo" placeholder="유저ID를 검색하세요" single-line clearable
        v-model="searchQuery" :append-inner-icon="mdiMagnify" @click:append-inner="searchFriendsHandler"
        @keyup.enter="searchFriendsHandler" hide-details>
      </v-text-field>
